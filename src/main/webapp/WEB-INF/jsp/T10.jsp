	...
	<nav class="navbar navbar-default">
			<div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-right text-center list-inline">
                        <li><a href="">首页</a></li>
                        <li><a href="${pageContext.request.contextPath}/t11/index.html">职业</a></li>
                        <li><a href="">推荐</a></li>
                        <li><a href="">关于</a></li>
                    </ul>
                </div>
	...
	<div class="main container">
            ...
            <div class="main-a row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                    <p>
                        <img src="${pageContext.request.contextPath}/t10/imges/453254312.png">${xueyuanrenshu}<br>
                        <span class="up-3">累计在线学习人数</span>
                    </p>
                    <p>
                        <img src="${pageContext.request.contextPath}/t10/imges/453254312.png">${javaxuexirenshu}<br>
                        <span class="up-3">java学习人数</span>
                    </p>
                </div>
            </div>
