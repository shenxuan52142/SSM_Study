...
public class Birth {
    static int[] lunarInfo = new int[]{0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260,
    ...
    static String[] Gan = new String[]{"甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬",
            "癸"};
    static String[] Zhi = new String[]{"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申",
            "酉", "戌", "亥"};
    static  long[] sTermInfo = new long[]{0, 21208, 42467, 63836, 85337, 107014,
     ...
     */
    public static Map horoscope(String date) throws ParseException {
